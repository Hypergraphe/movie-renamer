...
#
# Created: Mon Oct 22 14:26:29 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/document-open.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAddDirectory.setIcon(icon)
        self.actionAddDirectory.setObjectName(_fromUtf8("actionAddDirectory"))
        self.actionSave = QtGui.QAction(MainWindow)
        self.actionSave.setEnabled(True)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/document-save.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon1)
        self.actionSave.setObjectName(_fromUtf8("actionSave"))
        self.actionLaunchRenameAssistant = QtGui.QAction(MainWindow)
        self.actionLaunchRenameAssistant.setEnabled(True)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/system-run.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLaunchRenameAssistant.setIcon(icon2)
        self.actionLaunchRenameAssistant.setObjectName(_fromUtf8("actionLaunchRenameAssistant"))
        ...
        self.actionLaunchFromSelection = QtGui.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/media-playback-start.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLaunchFromSelection.setIcon(icon4)
        self.actionLaunchFromSelection.setObjectName(_fromUtf8("actionLaunchFromSelection"))
        self.actionSettings = QtGui.QAction(MainWindow)
        self.actionSettings.setObjectName(_fromUtf8("actionSettings"))
        self.actionImportAFile = QtGui.QAction(MainWindow)
        self.actionImportAFile.setObjectName(_fromUtf8("actionImportAFile"))
        self.actionImportADirectory = QtGui.QAction(MainWindow)
        self.actionImportADirectory.setObjectName(_fromUtf8("actionImportADirectory"))
        self.actionAddFiles = QtGui.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/add.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAddFiles.setIcon(icon5)
        self.actionAddFiles.setObjectName(_fromUtf8("actionAddFiles"))
        self.menuAide.addAction(self.actionAbout)
        self.menuFichier.addAction(self.actionAddFiles)
        self.menuFichier.addAction(self.actionAddDirectory)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSave.setText(QtGui.QApplication.translate("MainWindow", "Save All", None, QtGui.QApplication.UnicodeUTF8))
        self.actionLaunchRenameAssistant.setText(QtGui.QApplication.translate("MainWindow", "Rename assistant", None, QtGui.QApplication.UnicodeUTF8))
        self.actionQuit.setText(QtGui.QApplication.translate("MainWindow", "Quit", None, QtGui.QApplication.UnicodeUTF8))
        self.actionQuit.setShortcut(QtGui.QApplication.translate("MainWindow", "Ctrl+Q", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAbout.setText(QtGui.QApplication.translate("MainWindow", "About", None, QtGui.QApplication.UnicodeUTF8))
        self.actionLaunchFromSelection.setText(QtGui.QApplication.translate("MainWindow", "Rename from current selection", None, QtGui.QApplication.UnicodeUTF8))
        self.actionLaunchFromSelection.setToolTip(QtGui.QApplication.translate("MainWindow", "Rename from current selection", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSettings.setText(QtGui.QApplication.translate("MainWindow", "Settings", None, QtGui.QApplication.UnicodeUTF8))
        self.actionImportAFile.setText(QtGui.QApplication.translate("MainWindow", "Import a file", None, QtGui.QApplication.UnicodeUTF8))
        self.actionImportADirectory.setText(QtGui.QApplication.translate("MainWindow", "Import a directory", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAddFiles.setText(QtGui.QApplication.translate("MainWindow", "Add Files", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAddFiles.setToolTip(QtGui.QApplication.translate("MainWindow", "Add Files", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAddFiles.setStatusTip(QtGui.QApplication.translate("MainWindow", "Add Files", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAddFiles.setWhatsThis(QtGui.QApplication.translate("MainWindow", "Add Files", None, QtGui.QApplication.UnicodeUTF8))
